...
public class GetPricesHandler {
	...
	public ResponseEntity<PriceResponse> price(@PathVariable(value = "brandId") Long brandId,
		...
		PriceResponse priceResponse = new PriceResponse(price.getBrandId(),price.getProductId(),price.getPriceList(), price.getStartDate(), price.getEndDate(), price.getPrice());
